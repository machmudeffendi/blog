...
<div class="m-auto">
  ...
  <form action="{{ route('login') }}" method="post">
    ...
    <div class="border p-5 rounded" style="width: 50vh">
      <h2 class="border-bottom pb-3"><a href="{{Route('home')}}">BLOG</a> | Login</h2>
      <div class="form-group my-2 mt-3">
        <label class="label" id="email">Email</label>
        <input type="text" name="email" id="email" class="form-control" placeholder="nathan@example.com"/>
      </div>
      ...
      <div class="form-group my-3 d-flex flex-column align-items-end">
        <span class="">Tidak punya akun? <a href="{{Route('register')}}">Daftar disini</a></span>
      </div>
